...
{
    public partial class Addmodelstoproducts : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredOn = table.Column<DateTime>(nullable: true, defaultValue: new DateTime(2020, 11, 6, 12, 23, 59, 281, DateTimeKind.Utc).AddTicks(9675)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(nullable: false),
                    UserId = table.Column<string>(nullable: false),
                    PurchasedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 11, 6, 12, 23, 59, 281, DateTimeKind.Utc).AddTicks(3212))
                },
                constraints: table =>
                {
