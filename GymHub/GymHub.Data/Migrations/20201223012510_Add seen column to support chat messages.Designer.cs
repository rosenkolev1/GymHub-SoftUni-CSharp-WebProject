...
namespace GymHub.Data.Migrations
{
    ...
    [Migration("20201223012510_Add seen column to support chat messages")]
    partial class Addseencolumntosupportchatmessages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymHub.Data.Models.ContactsChatMessage", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ContactsChatMessages");
                });
            ...
            modelBuilder.Entity("GymHub.Data.Models.Sale", b =>
                {
                    ...
                    b.Property<DateTime>("PurchasedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 23, 1, 25, 9, 928, DateTimeKind.Utc).AddTicks(2157));
            ...
            modelBuilder.Entity("GymHub.Data.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("RegisteredOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 23, 1, 25, 9, 929, DateTimeKind.Utc).AddTicks(2917));
            ...
            modelBuilder.Entity("GymHub.Data.Models.ContactsChatMessage", b =>
                {
                    b.HasOne("GymHub.Data.Models.User", "Receiver")
                        .WithMany("ContactsChatMessagesReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GymHub.Data.Models.User", "Sender")
                        .WithMany("ContactsChatMessagesSent")
            ...
            modelBuilder.Entity("GymHub.Data.Models.User", b =>
                {
                    ...
                    b.Navigation("ContactsChatMessagesReceived");

                    b.Navigation("ContactsChatMessagesSent");
